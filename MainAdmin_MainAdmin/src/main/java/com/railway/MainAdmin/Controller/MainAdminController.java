...
public class MainAdminController {
	...
	public Train getTrain(@PathVariable String train_no){
		return repo.getTrainbyTrain_no(train_no);
	}
	
	@DeleteMapping("/delete/{train_no}")
	public String deleteTrain(@PathVariable String train_no) {
		repo.deleteTrain(train_no);
		return "Admin deleted train with train no:" +train_no;
	}
